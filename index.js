...
function findLastEvenNumber(arr) {
  ...
  const foundLastItem = arr.findLast((element) => element % 2 === 0);
  return foundLastItem !== undefined ? foundLastItem : 'Парних чисел не знайдено';
...
function getSubArrayAndConvertToString(arr, startIdx) {
  ...
  const convertToString = subArray.join(" ");
...
function getArrayKeys(arr) {
  ...
  const keysArray = Array.from(getKeys);
  return keysArray;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function getPositiveArrayValues(arr) {
  ...
  const objIterator = arr.values();
  const convertToArray = Array.from(objIterator);
  const filtered = convertToArray.filter(arr => arr > 0);
  return filtered;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function removeAndDouble(arr, startIdx) {
  ...
  arr.splice(startIdx);
  const doubleElem = arr.map(x => x * 2);
  return doubleElem;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function flattenSquareAndFilter(arr, threshold) {
  ...
  const mapped = flated.map(x => x ** 2);
  const filtered = mapped.filter((element) => {
...
function getLastElementsSumAndPrint(arr, n) {
  ...
  const reverseArray = lastElement.reduceRight((accumulator, currentValue) => {
    return accumulator + currentValue;
  }, 0);
...
function wordLengths(arr) {
  ...
  const newArray = arr.map(x => x.length);
  return newArray;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні, повертаємо 'Вхідний параметр має бути масивом'
...
function findLongestWord(arr) {
  ...
  const theLongestWord = arr.reduce((longest, current) => {
...
function findDuplicateElements(arr) {
  ...
  const duplicateElements = arr.filter((element, index, array) => {
